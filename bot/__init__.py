...
if len(AUTHOR_URL) == 0:
    AUTHOR_URL = 'https://t.me/Magic_Mirror_Updates'
...
if len(GD_INFO) == 0:
    GD_INFO = 'Uploaded by Magic Mirror Bot'
...
if len(CHANNEL_USERNAME) == 0:
    CHANNEL_USERNAME = 'Magic_Mirror_Updates'
...
if len(IMAGE_URL) == 0:
    IMAGE_URL = 'https://telegra.ph/file/1b608681770c8cb2b7bb6.png'
